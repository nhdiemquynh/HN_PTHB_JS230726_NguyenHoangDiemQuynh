...
var getTaskByIdController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, task_service_1.getTaskById)(parseInt(req.params.id))];
            case 1:
                task = _a.sent();
                if (!task) {
...
var addTaskController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, name_1 = _a.name, status_1 = _a.status;
                return [4 /*yield*/, (0, task_service_1.addTask)(name_1, status_1)];
            case 1:
                newTask = _b.sent();
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                id = req.params.id;
                _a = req.body, name_2 = _a.name, status_2 = _a.status, isDone = _a.isDone;
                return [4 /*yield*/, (0, task_service_1.updateTask)(parseInt(id), name_2, status_2)];
            case 1:
                updatedTask = _b.sent();
                if (updatedTask) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, (0, task_service_1.deleteTask)(parseInt(id))];
            case 1:
                deletedTask = _a.sent();
                if (deletedTask === 1) {
